...
- If your recipe is going to expose a service over TCP and UDP on a same port, then please check this [article](https://ben-lab.github.io/kubernetes-UDP-TCP-bug-same-port/) how to workaround a bug in Kubernetes.
